...
*Table: PopQA routing performance. Note: PopQA has an inherently massive base error rate (~90.6%). At a 5% budget, output confidence actually performed worse than chance (87.5% precision). Workspace noise restored precision to 100% (on a small sample of ~98 queries), demonstrating utility in extreme low-frequency fact retrieval.*
